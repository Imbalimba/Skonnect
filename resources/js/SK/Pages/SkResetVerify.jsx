...
const SkResetVerify = () => {
  const { pendingVerification, verifyOtp, resendOtp, getOtpStatus } = useContext(AuthContext);
  ...
  const type = location.state?.type || (pendingVerification.purpose === 'reset' ? pendingVerification.type : 'sk_reset');
